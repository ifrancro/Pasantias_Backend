...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ClubLocationRejectedException.class)
    public ResponseEntity<Map<String, Object>> handleClubLocationRejected(ClubLocationRejectedException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("success", false);
        body.put("error", ex.getErrorCode());
        body.put("message", ex.getMessage());
    ...
    @ExceptionHandler(PointsRecalculationRejectedException.class)
    public ResponseEntity<Map<String, Object>> handlePointsRecalculationRejected(
            PointsRecalculationRejectedException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("success", false);
        body.put("error", ex.getErrorCode());
        body.put("message", ex.getMessage());
